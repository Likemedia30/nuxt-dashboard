<template>
  <agile class="c-slider" :options="options">
    <div class="slide" v-for="(item, i) in testimonials" :key="i">
      <v-card
        class="c-card"
        >
